...
lib.start = function (config) {
    return new Promise(function (ok, ko) {
        ...
        try {
            ...
            var flowFile = path.resolve(_config.getInstancesDir() + "/" + config.uid + "/flows.json");
            var nodesDir = path.resolve(_config.getRedPath() + "/nodes");
...
//                    stream.pipe(process.stdout);
                    ...
                    processLogger.debug("Volume mapping:");
                    processLogger.debug(flowFile + ":/flows.json");
                    processLogger.debug(nodesDir + ":/nodes");
                    
                    container.start({
                        Binds: [
                          flowFile + ":/flows.json",
                          nodesDir + ":/nodes",
                          _config.getRedPath() + ":/node-red"
                        ]
                    }, function(err, data) {
