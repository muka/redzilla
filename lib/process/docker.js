...
lib.start = function (config) {
    ...
    return lib.setup(config.dir, config.settings)
      .catch(function() {
...
lib.prepareConfig = function(name, iconf) {
    return util.prepareConfig(name, iconf).then(function(conf) {
        ...
        conf.userDir = getConfig().volumes.userDir
        conf.nodesDir = getConfig().volumes.nodesDir
