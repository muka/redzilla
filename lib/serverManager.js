...
lib.setupProxy = function(app) {
    ...
    app.all(userPathPrefix + '/:name', function(req, res, next) {
        ...
        if(!instance) {
            ...
            res.setHeader('Location', adminPathPrefix + '/create/' + name + '?redirect=1');
    ...
    var adminCreate = function (req, res) {
        ...
        processManager.load(name).then(function(instance) {
            ...
            setTimeout(function() {
                ...
                result.uri = lib.getUserUri(instance);
    ...
    app.get(adminPathPrefix + '/:name/:op', adminOps);

    // Create or load instance
    // GET  admin-url/create/:name?redirect=1|0
    // POST admin-url/:name
    app.get(adminPathPrefix + '/create/:name', adminCreate);
    app.post(adminPathPrefix + '/:name', adminCreate);
